...
export class EthrDidResolver {
    protected contracts: ConfiguredNetworks;
                            ...
                            case 'pub': {
                                ...
                                switch (encoding) {
                                    ...
                                    case 'hex':
                                        ...
                                        break;
                                    case 'base64':
                                        pk.publicKeyBase64 = Buffer.from(currentEvent.value.slice(2), 'hex').toString(
                                            'base64',
                                        );
                                        break;
                                    case 'base58':
                                        pk.publicKeyBase58 = Base58.encode(
                                            Buffer.from(currentEvent.value.slice(2), 'hex'),
                                        );
                                        break;
                                    case 'pem':
